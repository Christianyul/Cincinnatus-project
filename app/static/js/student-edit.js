var reference_json = location.href.split("/")[4];
...
input_address = document.getElementById("address"), input_course = document.getElementById('actual_course'), 
input_nationality = document.getElementById('nationality');
...
$.ajax({
  ...
  data.All_Data.forEach(function(element) {
    if (element.id == reference_json) {
      ...
      input_identification.value = element.id_document, input_address.value = element.address, input_nationality.value = element.nationality;
    }
  }, this);
});